...
ghenv.Component.Message = '(2) Points to gcode / 200912'


comp_info = "ver1_200912"
Z_OFFSET_VALUE = INFO
M4_S_VALUE = 0
M4_STOP_TIME = 0
...
### Points to Gcode
if RUN_AND_EXPORT:
    gcode = op_bg.points_list_to_gcode_no_origin(POINTS, comp_info, M7_ON, M3_S_VALUE, M3_S_VALUE_1st, M4_S_VALUE, F_VALUE, F_VALUE_1st, Z_OFFSET_VALUE, M4_STOP_TIME, Z_BUFFER)
